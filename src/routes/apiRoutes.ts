...
router.get("/events/:eventId", apiController.getSpecificEventWithMembers.bind(apiController));
...
router.get("/members/test", apiController.getMembersWithAdressTest.bind(apiController));
